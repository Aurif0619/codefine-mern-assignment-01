          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {!isAuthenticated ? (
              ...
              <div className="flex items-center space-x-6">
                ...
                <button className="px-5 py-2 bg-gradient-to-r from-red-700 to-rose-700 text-white rounded-full hover:from-red-800 hover:to-rose-800 transition-all duration-300 font-medium shadow-lg hover:shadow-xl">
                  Logout
                </button>
              </div>
            )}
